      ...
      <div class="flex flex-wrap -mx-6">
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
          <div class="px-5 py-6 bg-primary rounded-xl shadow-sm">
            <Router-link
              class="text-white font-semibold font-Poppins flex justify-center gap-5"
              to="/forms"
            >
              <svg
                width="20"
        ...
        <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-3xl">
          <table class="min-w-full">
            <thead>
              <tr>
                <th
                  class="px-6 py-3 text-xs  leading-4 tracking-wider text-left text-navy  font-bold border-b border-gray-200 bg-gray-50"
                >
                  Featured
                </th>
                <th
