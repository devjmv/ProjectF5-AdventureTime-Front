        ...
        <div class="bg-white rounded-3xl shadow-md">
          ...
          <form @submit.prevent="registerEvent">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2 p-6">
              <div>
                <label class="text-random-50 font-semibold" for="title">Title *</label>
                <input
                  v-model="title"
                  id="title"
              ...
              <div>
                <label class="text-random-50 font-semibold" for="description">Description *</label>
                <textarea
                  v-model="description"
                  id="description"
                  class="block w-full px-4 py-2 mt-2 text-gray-900 placeholder-gris-300 bg-transparent border border-random-50 rounded-md focus:ring-random-50 focus:outline-random-50 focus:ring focus:ring-opacity-40"
              ...
              <div>
                <label class="text-random-50 font-semibold" for="imageUrl">Image URL *</label>
                <input
                  v-model="imageUrl"
                  id="imageUrl"
                  class="block w-full px-4 py-2 mt-2 text-gray-900 placeholder-gris-300 bg-transparent border border-random-50 rounded-md focus:ring-random-50 focus:outline-random-50 focus:ring focus:ring-opacity-40"
              ...
              <div>
                <label class="text-random-50 font-semibold" for="eventDateTime">Event Date & Time *</label>
                <input
              ...
              <div>
                <label class="text-random-50 font-semibold" for="maxParticipants">Max Participants *</label>
                <input
              ...
              <div>
                <label class="text-random-50 font-semibold" for="isAvailable">Is Available?</label>
                <input
                  v-model="isAvailable"
                  id="isAvailable"
                  class="block w-full px-4 py-2 mt-2 text-gray-900 placeholder-gris-300 bg-transparent border border-random-50 rounded-md focus:ring-random-50 focus:outline-random-50 focus:ring focus:ring-opacity-40"
              ...
              <div>
                <label class="text-random-50 font-semibold" for="isFeatured">Is Featured?</label>
                <input
                  v-model="isFeatured"
                  id="isFeatured"
                  class="block w-full px-4 py-2 mt-2 text-gray-900 placeholder-gris-300 bg-transparent border border-random-50 rounded-md focus:ring-random-50 focus:outline-random-50 focus:ring focus:ring-opacity-40"
